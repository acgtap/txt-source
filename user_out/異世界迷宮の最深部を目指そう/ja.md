...
## 10010 1章.挑戦の始まり/16.暗闇、麻痹、恐怖、沉黙、混亂、高揚、暴走
...
- '「那個業余……」（ ：可能是我多心了，總感覺アマ是那種小混混說的碧池的意思）'
- '但是緹亞馬上就轉移了話題（ディアが話をせびってきたので），所以我也沒有找出這個違和感到底是什麼。'


## 10020 2章.聖誕祭の終わりに/41.迷宮の溫度、戰いの溫度

- '對著蛋疼的現實感到悲劇、我用魔法『ディメンション』見到了『正道』的終點了。'
- '在２０層待機的女騎士一個是『天上的七骑士（セレスティアル・ナイツ）』的一員吧。'
- '拉古涅醬的狀態相對『天上的七骑士（セレスティアル・ナイツ）』來說要低一些。但是從拉絲緹婭拉險峻的表情有某些沒有這種感覺。'
- '就算是這樣，到了這種地步我還是不能輕易的輸掉。我把魔法『維度・决戰演算（グラディエイト）』加強展開。'
- '我一開始使用的魔法『維度・决戰演算（グラディエイト）』掌握到了情況、把劍勉強上挑將刀刃的軌道偏離才得以避免直擊。'
...
- '要是向她打聲招呼就好了，我對此感到後悔。不過，她總是能做出超出想象的行動，所以沒有問題的。是不是過於自信了？（譯：不懂呢 問題，なくタイミングを合わせられるかと過信してしまった。）'


## 10020 2章.聖誕祭の終わりに/45.抵達24層

- '『恩。另外啊，瑪利亞醬，今天想吃肉的料理。我想吃那種有平民感的，缺乏細膩的料理，拜托了～～』（こう、庶民的な、大味で、がっつりと食べられるようなやつでお願い）'
...
- '作戰很簡略。只要我們相互合作，利用自身的爆发力。（僕たちは連攜して爆発力が生まれるわけでもないので）'
- '『──神聖魔法『紫苑（シオン）』』'
...
## 10020 2章.聖誕祭の終わりに/47.做出理智的判斷理智的墮落
...
## 10020 2章.聖誕祭の終わりに/51.相川渦波得到的戰意
...
- 'そして５５話。懲りずに回想です。'
- '哈因です。'
- '「啊啊，這就是我們弗茲亞茲国的悲願（意思應該是宏願，但是用悲願比較帶感～），魔法技術的結晶。那個聖人緹婭拉的殘留，即將到來的『重生魔法』的素體（語尾不知道要用あたる，這個一般都用在語首，而且是劇場用語啊，即將到來的意思，這個坑貨，猜死我了……）。」'
...
## 10020 2章.聖誕祭の終わりに/58.天上的七騎士第四序列塞拉・雷迪安特、第五序列拉古涅・卡伊庫歐拉
...
## 10030 3章.報われない君が為に/101.『一ノ月連合國總合騎士團種舞踏會』南エリア第一試合
...
## 10040 4章.私と貴方がここにいる証明/145.息のできない再會
...
## 10060 6章.唯二人の家族/259.自獄四十，二童歸至。恆白物語，流溢於此。
...
- 'ラスティアラ視點でいいのかな……？　物語を読むラスティアラを見るライナー視點……？'
...
- '「はぁっ、ははっ、はぁっ、ははははっははっ──！これが戀人たち定番の追いかけっこ？　これ、追いかけっこでいいよね！？」'
...
- '一匹目のモンスターはローズダイル。百メートルほど離れた地點で補足した。'
- '「モンスター」ローズダイル：ランク４２'
- '「へー、ここがティティー姉の階層かー」'
