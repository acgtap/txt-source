...
- '理由としては、自分でも思った以上に加拉哈德戰爭のストーリーの進みが遅い⋯という殘念なものですが、どうぞこれからもお付き合いいただければ幸いです。一応、ストックの方は最低限は稼いでいるので、２３章以後の更新についてもご安心ください。'
...
- '今話において、子供が殺される描寫がありました。もし、不快に感じる方がいましたら、申し訳ありません。ほとんど分かり切った展開ではありますが、一応、內容のネタバレは控えたいので、前書きで注意は書きませんでした。'
...
- 'この話は利用規約に抵觸する恐れがあるので、內容を一部削除した上で公開されております。該當箇所をそのまま削除しているだけですので、話の繋がりは途切れています。'
